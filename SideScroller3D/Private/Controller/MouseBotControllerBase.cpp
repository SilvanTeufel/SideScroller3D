			...
			if(MouseBot->CurrentEnemy)
			{
				...
				if(!MouseBot->AttackBottom)
				{
					...
					if(MouseBot->AttackIterationTime >= 1.f)
					{
						...
						MouseBot->CurrentEnemy->SetHealth(MouseBot->CurrentEnemy->Attributes->GetHealth()-MouseBot->AttackDamage);
					}
			...
			if(MouseBot->CurrentFriend)
			{
				...
				if(!MouseBot->HealBottom)
				{
					...
					if(MouseBot->HealIterationTime >= 1.f)
					{
						...
						MouseBot->CurrentFriend->SetHealth(MouseBot->CurrentFriend->Attributes->GetHealth()+MouseBot->HealPoints);
						if(MouseBot->CurrentFriend->Attributes->GetHealth() >= MouseBot->CurrentFriend->Attributes->GetMaxHealth())
						{
							MouseBot->SetAnimState(BotData::Run_Bot);
						}
					}
